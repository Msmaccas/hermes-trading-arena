...
[1] "The 85-85 screen (EPS 85+ and RS 85+) is my starting point every morning. That filters out 95% of garbage."
    ...
    => f'EPS rating fails because net income growth is +177.29999999999998% (requirement is 20% minimum in CANSLIM). RS rating fails because RS line is NOT making new highs. The first filter kills this stock — I'd never even see it.
