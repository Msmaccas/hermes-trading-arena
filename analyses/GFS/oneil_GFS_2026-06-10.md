...
[2] "Current Quarterly Earnings per Share: The Higher, the Better."
    ...
    => f'Net income growth +3.1% per current period filings. CANSLIM requires 20% MINIMUM. Even using revenue growth of +3.1%, ideal is 40-100-200%. GFS fails 'C' completely.

[3] "Annual Earnings Increases: Look for Significant Growth."
    Source: How to Make Money in Stocks (4th ed.), CAN SLIM introduction [p.15]
    => f'Revenue +3.1% while net income +3.1% means costs are spiraling. CANSLIM requires 25% minimum sales growth. This stock is growing revenue but not profits — that's a warning, not a signal.
...
Indicators Used:
  ...
  - Revenue growth: +3.1% (requires 25% minimum)
