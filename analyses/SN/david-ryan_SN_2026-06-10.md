...
[1] "The 85-85 screen (EPS 85+ and RS 85+) is my starting point every morning. That filters out 95% of garbage."
    ...
    => f'EPS rating fails because net income growth is +3.1% (requirement is 20% minimum in CANSLIM). RS rating fails because RS line is NOT making new highs. The first filter kills this stock — I'd never even see it.
...
[4] "Cut your losers like a cancer. If a stock isn't acting right, get rid of it immediately. Don't hope it comes back."
    Source: IBD TV: https://www.investors.com/research/investing-lessons-from-david-ryan/
    => f'CFO sold 80% of holdings. Chairman $5.5M secondary. This stock 'isn't acting right.' The people closest to it are getting out. Cut it.
