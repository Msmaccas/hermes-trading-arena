...
[3] "The secret to compounding is not big winners — it's not having big losers. Protect the downside and the upside takes care of itself."
    Source: Mindset, Methods, and Market Strategies (2022)
    => f'CFO sold 0% of holdings. Chairman sold $0.0M secondary. 0.0M recalled units. 0 class actions. Net income only +25.3% on +25.3% revenue. This is a litany of downside risks. Protecting the downside means AVOIDING this stock entirely.
